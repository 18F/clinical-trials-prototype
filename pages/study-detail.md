...
<div class="usa-grid">
  ...
  <aside class="usa-width-one-fourth">
    <ul class="usa-sidenav-list">
      <li>
        <a class="usa-current" href="javascript:void(0);">Overview</a>
        <ul class="usa-sidenav-sub_list">
          <li>
            <a href="javascript:void(0);">Purpose</a>
          </li>
          <li>
            <a href="javascript:void(0);">What’s being tested</a>
          </li>
          <li>
            <a href="javascript:void(0);">Additional study details</a>
          </li>
        </ul>
      </li>
      <li>
        ...
        <ul class="usa-sidenav-sub_list">
          <li>
            <a href="javascript:void(0);">Enrolling in a trial</a>
          </li>
          <li>
            <a href="javascript:void(0);">Eligibility</a>
          </li>
          <li>
            <a href="javascript:void(0);">Criteria</a>
          </li>
        </ul>
      </li>
      <li>
      ...
      <li>
        <a href="javascript:void(0);">Study details</a>
        <ul class="usa-sidenav-sub_list">
          <li>
          ...
          <li>
            <a href="javascript:void(0);">External health links</a>
          </li>
        </ul>
      </li>
    </ul>
  ...
  <div class="usa-width-three-fourths">
    ...
    <div class="usa-alert usa-alert-info">
      <div class="usa-alert-body">
        <h3 class="usa-alert-heading">Enrolling in a trial</h3>
    ...
    <h3>What criteria do I need to meet?</h3>
    ...
    <h3>Keywords provided by sponsor</h3>
    <p><a href="#">family</a>, <a href="#">caregiving</a>, <a href="#">ptsd</a>, <a href="#">couples</a></p>
    <h3>MedlinePlus external health links</h3>
